...
/storage/htc/bdm/tools/HHsuite/hhsuite-2.0.16/bin/hhblits -i T0966.fasta -d /storage/htc/bdm/tools/databases/uniprot20_2016_02/uniprot20_2016_02 -oa3m hhb-cov60.a3m -cpu 2 -n 3 -maxfilt 500000 -diff inf -e 0.001 -id 99 -cov 60 > hhb-cov60-hhblits.log
